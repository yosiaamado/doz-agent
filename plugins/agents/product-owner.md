...
- Kalau setelah budget itu masih ada yang belum jelas, atau sudah ±10 tool call (70% dari `maxTurns` 15), **berhenti mencari** dan tulis output — sisanya jadi asumsi atau pertanyaan.
